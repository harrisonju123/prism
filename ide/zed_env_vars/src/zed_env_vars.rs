...
/// Whether Prism is running in stateless mode.
/// When true, Prism will use in-memory databases instead of persistent storage.
pub static ZED_STATELESS: LazyLock<bool> = bool_env_var!("PRISM_STATELESS");
