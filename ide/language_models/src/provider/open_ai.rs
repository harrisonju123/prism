    ...
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let api_key_section = if self.should_render_editor(cx) {
            v_flex()
                ...
                .child(Label::new("To use Prism's agent with OpenAI, you need to add an API key. Follow these steps:"))
                .child(
                    List::new()
                        .child(
                            ListBulletItem::new("")
        ...
        let compatible_api_section = h_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(Label::new("Prism also supports OpenAI-compatible models.")),
            )
            .child(
                Button::new("docs", "Learn More")
                    ...
                    .on_click(move |_, _window, cx| {
                        cx.open_url("https://prism-ide.dev/docs/ai/llm-providers#openai-api-compatible")
                    }),
            );
