...
def get_release_info(tag: str):
    url = f"https://api.github.com/repos/harrisonju123/PrisM/releases/tags/{tag}"
...
if __name__ == "__main__":
    ...
    release_info_str += f"    </description>\n"
    release_info_str += f"    <url>https://github.com/harrisonju123/PrisM/releases/tag/{tag}</url>\n"
    release_info_str += "</release>\n"

    channel_releases_file = f"../../ide/zed/resources/flatpak/release-info/{channel}"
