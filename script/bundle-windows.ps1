...
function BuildInstaller {
    ...
    switch ($channel) {
        "stable" {
            ...
            $appExeName = "Prism"
            $regValueName = "Prism"
            $appUserId = "harrisonju123.Prism"
            $appShellNameShort = "P&rism"
            $appAppxFullName = "harrisonju123.Prism_1.0.0.0_neutral__japxn1gcva8rg"
        }
        "preview" {
            ...
            $appUserId = "harrisonju123.Prism.Preview"
            $appShellNameShort = "P&rism Preview"
            $appAppxFullName = "harrisonju123.Prism.Preview_1.0.0.0_neutral__japxn1gcva8rg"
        }
        "nightly" {
            ...
            $appUserId = "harrisonju123.Prism.Nightly"
            $appShellNameShort = "P&rism Editor Nightly"
            $appAppxFullName = "harrisonju123.Prism.Nightly_1.0.0.0_neutral__japxn1gcva8rg"
        }
        "dev" {
            ...
            $appUserId = "harrisonju123.Prism.Dev"
            $appShellNameShort = "P&rism Dev"
            $appAppxFullName = "harrisonju123.Prism.Dev_1.0.0.0_neutral__japxn1gcva8rg"
        }
        default {
