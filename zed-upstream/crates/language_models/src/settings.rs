...
use crate::provider::{
    anthropic::AnthropicSettings, bedrock::AmazonBedrockSettings, deepseek::DeepSeekSettings,
    ...
    open_router::OpenRouterSettings, prism::PrismSettings, vercel::VercelSettings,
