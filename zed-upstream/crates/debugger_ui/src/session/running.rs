    ...
    pub(crate) fn resolve_scenario(
        ...
        cx.spawn_in(window, async move |this, cx| {
            ...
            if config_is_valid {
                ...
                anyhow::bail!("Prism cannot determine how to run this debug scenario. `build` field was not provided and Debug Adapter won't accept provided configuration because: {e}");
            };
