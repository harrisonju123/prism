...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            name: "Prism".into(),
            items: vec![
                MenuItem::action("About Prism", zed_actions::About),
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Prism", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Prism", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://github.com/harrisonju123/PrisM".into(),
                    },
                ),
                MenuItem::action("Prism Repository", feedback::OpenZedRepo),
            ],
        },
    ]
}
