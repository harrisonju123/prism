...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Prism Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Prism Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Prism Editor Preview Instance Running",
        ReleaseChannel::Stable => "Prism Editor Stable Instance Running",
    }
}
